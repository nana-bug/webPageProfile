        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="bg-white/5 border-l-2 border-neon-violet p-6 backdrop-blur-sm">
              ...
              {/*<a href="mailto:" className="flex items-center gap-4 text-slate-300 hover:text-neon-violet transition-colors group">
            ...
            <div className="flex gap-4">
              <SocialLink href="https://github.com/nana-bug" icon={<Github size={20} />} label="GitHub" />
              <SocialLink href="https://www.linkedin.com/in/ilce-m-421410117/" icon={<Linkedin size={20} />} label="LinkedIn" />
            </div>
          </div>

          {/* Form Side - Terminal Style */}
          <form className="bg-black/40 p-8 border border-white/10 clip-tech relative shadow-xl" onSubmit={handleSubmit}>
